    ...
    <div class="col-md-8 mx-auto">
        <div class="card card-premium card-outline card-primary">
            <div class="card-header bg-transparent border-0 pt-4 px-4">
                <h3 class="card-title font-weight-bold text-secondary mb-0"><i class="fas fa-edit mr-2"></i> Hadia Kargu / Posisaun</h3>
            </div>
            <form action="<?= base_url('admin/kargu/' . $kargu['id_kargu']) ?>" method="post" class="px-4 pb-4 pt-2">
                <?= csrf_field() ?>
                ...
                <div class="form-group mb-4">
                    ...
                    <input type="text" 
                           ...
                           value="<?= old('naran_kargu', $kargu['naran_kargu']) ?>" 
                           required>
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-rounded shadow-sm">Hadia Dadus</button>
                </div>
            </form>
        </div>
    </div>
