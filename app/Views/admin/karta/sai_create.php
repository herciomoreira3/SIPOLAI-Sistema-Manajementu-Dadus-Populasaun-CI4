    ...
    <div class="col-md-8 mx-auto">
        <div class="card card-premium card-outline card-primary">
            <div class="card-header bg-transparent border-0 pt-4 px-4">
                <h3 class="card-title font-weight-bold text-secondary"><i class="fas fa-plus mr-2"></i> Rejista Karta Sai Foun</h3>
            </div>
            <form action="<?= base_url('admin/karta-sai') ?>" method="POST" class="px-4 pb-4 pt-2">
                <?= csrf_field() ?>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="destinatariu" id="destinatariu" class="form-control <?= session('errors.destinatariu') ? 'is-invalid' : '' ?>" value="<?= old('destinatariu') ?>" placeholder="Fila destinatariu/ba..." required>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="date" name="data_sai" id="data_sai" class="form-control <?= session('errors.data_sai') ? 'is-invalid' : '' ?>" value="<?= old('data_sai') ?? date('Y-m-d') ?>" required>
                ...
                <div class="d-flex justify-content-between mt-4">
                    ...
                    <button type="submit" class="btn btn-primary btn-rounded">Kria Karta Sai</button>
                </div>
            </form>
        </div>
    </div>
