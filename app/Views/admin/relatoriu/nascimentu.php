            ...
            <div class="card-header bg-transparent border-0 pt-4 px-4">
                ...
                <?php else : ?>
                    <div class="text-center">
                        ...
                        <h4 class="text-secondary font-weight-bold mb-3">Relatoriu Nascimentu</h4>
                    </div>
                <?php endif; ?>
                    ...
                    <table class="table table-bordered table-striped align-middle">
                        ...
                        <tbody>
                            <?php if (empty($membros)) : ?>
                                <tr>
                                    <td colspan="6" class="text-center text-muted">Laiha dadus nascimentu foun.</td>
                                </tr>
                            <?php else : ?>
                                <?php $no = 1; foreach ($membros as $m) : ?>
                                    <tr>
                                        ...
                                        <td><?= esc($m['fatin_moris']) ?></td>
                                        <td>
                                            <?php if ($m['data_moris'] !== '-') : ?>
                                                <?= date('d-m-Y', strtotime($m['data_moris'])) ?>
                                            <?php else : ?>
                                                -
                                            <?php endif; ?>
                                        </td>
