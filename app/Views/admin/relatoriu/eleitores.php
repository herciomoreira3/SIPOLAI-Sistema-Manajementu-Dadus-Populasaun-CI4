            ...
            <div class="card-header bg-transparent border-0 pt-4 px-4">
                ...
                <?php else : ?>
                    <div class="text-center">
                        ...
                        <h4 class="text-secondary font-weight-bold mb-3">Relatoriu Eleitores Active</h4>
                    </div>
                <?php endif; ?>
                    ...
                    <table class="table table-bordered table-striped align-middle">
                        ...
                        <tbody>
                            <?php if (empty($membros)) : ?>
                                <tr>
                                    <td colspan="7" class="text-center text-muted">Laiha dadus eleitores ativu.</td>
                                </tr>
                            <?php else : ?>
