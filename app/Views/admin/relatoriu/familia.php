            ...
            <div class="card-header bg-transparent border-0 pt-4 px-4">
                ...
                <?php else : ?>
                    <div class="text-center">
                        ...
                        <h4 class="text-secondary font-weight-bold mb-3">Relatoriu Fixa Familia</h4>
                    </div>
                <?php endif; ?>
            ...
            <div class="card-body px-4 pb-4">
                <div class="table-responsive">
                    <table class="table table-bordered table-striped align-middle">
                        ...
                        <tbody>
                            <?php $no = 1; foreach ($familias as $fam) : ?>
                                <tr>
                                    <td><?= $no++ ?></td>
                                    <td class="font-weight-bold text-primary"><?= esc($fam['numeru_kk']) ?></td>
                                    <td><span class="badge badge-light p-2"><?= esc($fam['naran_aldeia']) ?></span></td>
                                    <td class="text-secondary font-weight-bold"><?= esc($fam['xefe_familia']) ?></td>
                                    <td>
                                        <span class="badge badge-info px-3 py-1"><?= $fam['total_membros'] ?> Ema</span>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
