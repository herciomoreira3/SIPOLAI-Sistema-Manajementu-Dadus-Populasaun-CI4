...
<div class="row">
    <div class="col-md-12">
        <div class="card card-outline card-primary">
            <form action="<?= route_to('admin/literatura') ?>/<?= $literatura['id_literatura'] ?>" method="post" class="form-horizontal">
                <?= csrf_field() ?>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" 
                                   ...
                                   value="<?= old('naran_literatura', $literatura['naran_literatura']) ?>" 
                                   required>
