...
class AddNoEleitoralAndMenu extends Migration
{
    public function up()
    {
        // 1. Add 'no_eleitoral' column to 'tabela_populasaun'
    ...
    public function down()
    {
        ...
        $menuItem = $db->table('menu')->where('title', 'Dados Eleitores')->get()->getRow();
        if ($menuItem) {
        ...
        $this->forge->dropColumn('tabela_populasaun', 'no_eleitoral');
    }
}
