...
use Boilerplate\Controllers\BaseController;
use Boilerplate\Entities\Collection;
use Boilerplate\Models\GroupModel;
use Boilerplate\Models\UserModel;
...
class UserController extends BaseController
{
    ...
    /** @var \Boilerplate\Models\UserModel */
    protected $users;
    ...
    public function index()
    {
        ...
        return view('Boilerplate\Views\User\index', [
    ...
    public function profile()
    {
        ...
        return view('Boilerplate\Views\User\profile', [
    ...
    public function new()
    {
        return view('Boilerplate\Views\User\create', [
            'title'       => lang('boilerplate.user.title'),
    ...
    public function edit($id)
    {
        ...
        return view('Boilerplate\Views\User\update', $data);
    }
