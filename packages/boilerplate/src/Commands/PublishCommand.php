...
class PublishCommand extends BaseCommand
{
    ...
    /**
     * The path to Boilerplate\src directory.
     *
     * @var string
     */
    ...
    protected function publishConfig()
    {
        ...
        $content = str_replace('namespace Boilerplate\Config', 'namespace Config', $content);
    ...
    protected function publishMigration()
    {
        ...
        foreach ($map as $file) {
            ...
            $content = str_replace('namespace Boilerplate\Database\Migrations', 'namespace '.APP_NAMESPACE.'\Database\Migrations', $content);
